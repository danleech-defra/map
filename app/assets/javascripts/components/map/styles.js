...
const pattern = (style, isSelected) => {
  ...
  switch (style) {
    case 'severe':
      context.fillStyle = isSelected ? '#FFDD00' : '#D4351C'
    ...
    case 'alert':
      ...
      context.fillRect(0, 0, 8, 8)
      context.beginPath()
      context.fillStyle = isSelected ? '#FFDD00' : '#F47738'
      context.moveTo(0, 3.3)
      context.lineTo(0, 4.7)
      context.lineTo(4.7, 0)
    ...
    case 'removed':
      ...
      context.fillRect(0, 0, 8, 8)
      context.beginPath()
      context.fillStyle = isSelected ? '#FFDD00' : '#626A6E'
