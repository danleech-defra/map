...
const styleCache = {
  ...
  levelErrorBig: createStyle({ offset: [0, 700], zIndex: 4 }),
  levelErrorBigSelected: createStyle({ offset: [100, 700], zIndex: 4 }),
  rainfallBig: createStyle({ offset: [0, 800], zIndex: 3 }),
  rainfallBigSelected: createStyle({ offset: [100, 800], zIndex: 3 }),
  levelHigh: createStyle({ offset: [0, 900], zIndex: 5 }),
  levelHighSelected: createStyle({ offset: [100, 900], zIndex: 5 }),
  level: createStyle({ offset: [0, 1000], zIndex: 4 }),
  levelSelected: createStyle({ offset: [100, 1000], zIndex: 4 }),
  levelError: createStyle({ offset: [0, 1100], zIndex: 4 }),
  levelErrorSelected: createStyle({ offset: [100, 1100], zIndex: 4 }),
  rainfall: createStyle({ offset: [0, 1200], zIndex: 3 }),
  rainfallSelected: createStyle({ offset: [100, 1200], zIndex: 3 })
}
